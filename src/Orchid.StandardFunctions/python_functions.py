# Orchid Standard Python Functions
# Python 3 compatible implementation using pythonnet
...
def if_error(orchid, args):
    ...
    res = [default if x.is_error() else x for x in [val.variable_at(i) for i in range(len(val))]]
